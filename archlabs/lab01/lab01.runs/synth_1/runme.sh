...
HD_PWD='E:/archlabs/lab01/lab01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flowing_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flowing_light.tcl
