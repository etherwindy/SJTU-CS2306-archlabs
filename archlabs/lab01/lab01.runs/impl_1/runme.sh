...
HD_PWD='E:/archlabs/lab01/lab01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flowing_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flowing_light.tcl -notrace
